        ...
        <div class="row text-center logSignForm">
            ...
            <div id="inscriptionForm" style = "display:none;" class="container w-100 col-12">
                <form action="inscription_post.php" method="post">
                    ...
                    <p>Numero de téléphone <br><input type="text" name="telnum" required/></p>
                    <?php if(isset($tel_error)) { ?>     <!-- On a cree l'erreur dans result.php ou si pseudo _ error est true (existe)(soit il est vide car il existe si et seulement si il est vide) , on l'affiche-->
                        <p class="form_error"> <?php echo $tel_error ?> </p> 
                         <?php } ?>
                    <p>Adresse <br><input type="text" name="adresse" required/></p>
                    <p>Code postal <br><input type="text" name="zip" required/></p>
                    <?php if(isset($zip_error)) { ?>     <!-- On a cree l'erreur dans result.php ou si pseudo _ error est true (existe)(soit il est vide car il existe si et seulement si il est vide) , on l'affiche-->
                        <p class="form_error"> <?php echo $zip_error ?> </p> 
                         <?php } ?>
